...
- символы возведения в степень `^` и модуль `|-x|`
...
> Вместо `fib.ms` можете выбрать любой понравившийся пример из папки `Examples`.
...
- Рекурсия. Функции могут вызывать себя и другие функции (`fib.ms`, `fact.ms`).
